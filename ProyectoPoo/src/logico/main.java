    ...
    public static void main(String[] args) {
        ...
        if (matches.isEmpty()) {
            ...
            for (ResultadoMatcheo rm : matches) {
                System.out.println("-> Candidato: " + rm.getSolicitud().getSolicitante().getUsuario());
        ...
        if(!matches.isEmpty()) {
            System.out.println("\n*** Contratando al mejor candidato (" + matches.get(0).getSolicitud().getSolicitante().getUsuario() + ") ***");
