...
public class Principal extends JFrame {
	...
	public Principal(Object usuarioLogueado) 
	{
		...
		mntmCrearSolicitud = new JMenuItem("Crear una solicitud");
		...
		mntmConsultarMisSolicitudes = new JMenuItem("Consultar mis Solicitudes");
		mntmConsultarMisSolicitudes.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ListarMisSolicitudes lista = new ListarMisSolicitudes((Persona) usuarioLogueado);
		        lista.setModal(true);
		        lista.setVisible(true);
		    }
		});
		mntmConsultarMisSolicitudes.setFont(new Font("Arial Narrow", Font.BOLD, 14));
		mnMisSolicitudes.add(mntmConsultarMisSolicitudes);
